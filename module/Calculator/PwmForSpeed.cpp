/**
 *  @file PwmForSpeed.cpp
 *  @brief 目標速度に対応するPWM値を算出するクラス
 *  @author CHIHAYATAKU
 */
#include "PwmForSpeed.h"

PwmForSpeed::PwmForSpeed(double _targetSpeed)
...
PwmForSpeed::PwmForSpeed(double _rightTargetSpeed, double _leftTargetSpeed)
...
double PwmForSpeed::calcSpeed(double diffMileage, double diffTime)
{
  // 走行時間が0のとき、0を返す
