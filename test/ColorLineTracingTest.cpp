...
namespace etrobocon2024_test {
  ...
  // 最初3回の色取得で連続して指定色を取得するテストケース（復帰動作なし）
  TEST(ColorLineTracingTest, runToGetFirstWithoutRecovery)
  {
    Controller controller;
    Measurer measurer;
    // PWMの初期化
  ...
  // 少し走ってから指定色を取得するテストケース（左エッジ走行，復帰動作なし）
  TEST(ColorLineTracingTest, runLeftEdgeWithoutRecovery)
  {
    Controller controller;
    Measurer measurer;
    // PWMの初期化
  ...
  // 少し走ってから指定色を取得するテストケース（右エッジ走行，復帰動作なし）
  TEST(ColorLineTracingTest, runRightEdgeWithoutRecovery)
  {
    Controller controller;
    Measurer measurer;
    // PWMの初期化
  ...
  // 少し走ってから指定色を取得するテストケース（バック，左エッジ走行，復帰動作なし）
  TEST(ColorLineTracingTest, runBackLeftEdgeWithoutRecovery)
  {
    Controller controller;
    Measurer measurer;
    // PWMの初期化
  ...
  // 少し走ってから指定色を取得するテストケース（バック，右エッジ走行，復帰動作なし）
  TEST(ColorLineTracingTest, runBackRightEdgeWithoutRecovery)
  {
    Controller controller;
    Measurer measurer;
    // PWMの初期化
